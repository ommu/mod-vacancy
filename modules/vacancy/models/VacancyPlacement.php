 ...
 * @created date 1 March 2017, 16:54 WIB
 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_vacancy_placement".
 *
 * The followings are the available columns in table 'ommu_vacancy_placement':
 * @property string $id
...
class VacancyPlacement extends CActiveRecord
{
	 ...
	 * @return VacancyPlacement the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('vacancy_id, province_id, city_id, creation_date, creation_id', 'required'),
			array('province_id', 'numerical', 'integerOnly'=>true),
			array('vacancy_id, city_id, creation_id', 'length', 'max'=>11),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, vacancy_id, province_id, city_id, creation_date, creation_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(!isset($_GET['VacancyPlacement_sort']))
