 ...
 * @created date 1 March 2017, 16:56 WIB
 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_vacancy_university".
 *
 * The followings are the available columns in table 'ommu_vacancy_university':
 * @property string $id
...
class VacancyUniversity extends CActiveRecord
{
	 ...
	 * @return VacancyUniversity the static model class
	 */
	...
	{
		return 'ommu_vacancy_university';
	}
	...
	public function rules()
	{
		...
		return array(
			array('vacancy_id, university_id, creation_date, creation_id', 'required'),
			array('vacancy_id, university_id, creation_id', 'length', 'max'=>11),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, vacancy_id, university_id, creation_date, creation_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(!isset($_GET['VacancyUniversity_sort']))
