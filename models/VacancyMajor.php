 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_vacancy_major".
 *
 * The followings are the available columns in table 'ommu_vacancy_major':
 * @property string $id
 ...
 */
class VacancyMajor extends CActiveRecord
{
	 ...
	 * @return VacancyMajor the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('vacancy_id, major_id, creation_date, creation_id', 'required'),
			array('vacancy_id, major_id, creation_id', 'length', 'max'=>11),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, vacancy_id, major_id, creation_date, creation_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(!isset($_GET['VacancyMajor_sort']))
