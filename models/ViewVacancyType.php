 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_vacancy_type".
 *
 * The followings are the available columns in table '_view_vacancy_type':
 * @property integer $type_id
 * @property string $vacancies
 * @property string $vacancy_all
 */
class ViewVacancyType extends CActiveRecord
{
	 ...
	 * @return ViewVacancyType the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('type_id, vacancies, vacancy_all', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('ViewVacancyType_sort'))
