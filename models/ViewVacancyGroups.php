 ...
 * @created date 1 March 2017, 16:57 WIB
 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_vacancy_groups".
 *
 * The followings are the available columns in table '_view_vacancy_groups':
 * @property string $group_id
 * @property string $vacancies
 * @property string $vacancy_all
 */
class ViewVacancyGroups extends CActiveRecord
{
	 ...
	 * @return ViewVacancyGroups the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('vacancies', 'length', 'max'=>23),
			array('vacancy_all', 'length', 'max'=>21),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('group_id, vacancies, vacancy_all', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('ViewVacancyGroups_sort'))
