 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_vacancy_setting".
 *
 * The followings are the available columns in table 'ommu_vacancy_setting':
 * @property integer $id
 ...
 */
class VacancySetting extends CActiveRecord
{
	use GridViewTrait;
	 ...
	 * @return VacancySetting the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('license, permission, meta_keyword, meta_description, profile_applicants, modified_id', 'required'),
			...
			array('id, license, permission, meta_keyword, meta_description, profile_applicants, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
