 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_vacancy_type".
 *
 * The followings are the available columns in table 'ommu_vacancy_type':
...
class VacancyType extends CActiveRecord
{
	 ...
	 * @return VacancyType the static model class
	 */
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('VacancyType_sort'))
