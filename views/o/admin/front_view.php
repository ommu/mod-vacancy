...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
		...
		array(
			'name'=>'started_date',
			'value'=>!in_array($model->started_date, array('0000-00-00','1970-01-01','0002-12-02','-0001-11-30')) ? $this->dateFormat($model->started_date) : '-',
		),
		array(
			'name'=>'closed_date',
			'value'=>!in_array($model->closed_date, array('0000-00-00','1970-01-01','0002-12-02','-0001-11-30')) ? $this->dateFormat($model->closed_date) : '-',
		),
		array(
			'name'=>'intro_text',
